...
var Artist = function Artist(_ref) {
  ...
  return _react.default.createElement("div", null, _react.default.createElement("h2", null, name), _react.default.createElement("h3", null, followers.total), _react.default.createElement("h3", null, genres.join(", ")), _react.default.createElement("img", {
...
},{"react":"../node_modules/react/index.js"}],"components/Track.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function Track() {
    ...
    _defineProperty(_assertThisInitialized(_this), "play", function (previewUrl) {
      return function () {
        var audio = new Audio(previewUrl);

        if (!_this.state.playmusic) {
          audio.play();
          ...
          _this.state.audio_mode.pause();

          if (_this.state.preview === previewUrl) {
            _this.setState({
              playmusic: false
            });
          } else {
    ...
    _defineProperty(_assertThisInitialized(_this), "playPause", function (tracks) {
      if (!tracks.preview_url) {
        return _react.default.createElement("span", null, "N/A");
      }

      if (_this.state.playmusic && _this.state.preview == tracks.preview_url) {
  ...
  _createClass(Track, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, track.map(function (tracks) {
        var id = tracks.id,
            album = tracks.album,
            name = tracks.name,
        ...
        return _react.default.createElement("div", {
          className: "track",
          key: id,
          onClick: _this2.play(preview_url)
...
function (_Component) {
  ...
  function Search() {
    ...
    _defineProperty(_assertThisInitialized(_this), "keyChange", function (event) {
      console.log('event.target.value', event.target.value);

      _this.setState({
        adder: event.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_this), "searchKey", function () {
      _this.props.searchKey(_this.state.adder);
    });
  ...
  _createClass(Search, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Music Master"), _react.default.createElement("input", {
...
function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchKey", function (query) {
      console.log(_this.state.adder);
      fetch("".concat(API_ADDRESS, "/artist/").concat(query)).then(function (response) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_Search.default, {
        searchKey: this.searchKey
      }), _react.default.createElement(_Artist.default, {
        artist: this.state.author
      }), _react.default.createElement("br", null), _react.default.createElement(_Track.default, {
        track: this.state.collections
      }));
    }
  }]);
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./Artist":"components/Artist.js","./Track":"components/Track.js","./Search":"components/Search.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
